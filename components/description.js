function Description() {
  return (
    <div className="w-full bg-gradient-to-t from-blue-800 to-blue-900 text-center text-gray-50 py-16 px-8 pb-64">
      <p className="font-bold text-2xl mb-5 sm:max-w-lg mx-auto">
        Hi, I’m Florian. Nice to meet you.
     </p>
      <p className="font-extralight text-md leading-7 sm:max-w-6xl mx-auto">
